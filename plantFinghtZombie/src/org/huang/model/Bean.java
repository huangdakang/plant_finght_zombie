...
public class Bean  extends Plant{
	...
	public void drawImage(Canvas canvas, Paint paint) {
		//根据植物所在的位置 来绘制图片
		canvas.drawBitmap(ImageUils.getBeanImages(getIndex()), getX(),getY(), paint);
	...
	public void drawCard(Canvas canvas, Paint paint, int index) {
		canvas.drawBitmap(ImageUils.getBeanCard(), (int )index*Globals.getOnePiceWidth()*2/3,0, paint);
