...
public class HatZombie extends Zombie {
	public HatZombie(int y) {
		setY(y);
	...
	public void drawImage(Canvas canvas, Paint paint) {
		...
		if(getLife()>0){
			canvas.drawBitmap(ImageUils.getHatZombieImages(getIndex()), getX(), (getY()-0.5f)*
