...
public class IconZombie extends Zombie {
	public IconZombie(int y) {
		setY(y);
	...
	public void drawImage(Canvas canvas, Paint paint) {
		...
		if(getLife()>0){
			Log.i("-------","-------index-----"+getIndex());
			canvas.drawBitmap(ImageUils.getIconZombieImages(getIndex()), getX(), (getY()-0.5f)*
